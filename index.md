...
<div class="timeline">
  <article class="timeline-item timeline-item--current">
    ...
    <div class="timeline-content">
      ...
      <p>Lead research on zero-shot website fingerprinting and cross-modal alignment, with a focus on secure and privacy-preserving networked systems.</p>
    </div>
  </article>
  <article class="timeline-item">
    ...
    <div class="timeline-content">
      ...
      <p>Conducted research on website and mobile-app fingerprinting, privacy-preserving traffic analysis, and robust machine-learning defenses under the supervision of Ee-Chien Chang.</p>
    </div>
  </article>
</div>
...
<div class="project-grid">
  <article class="project-card project-card--featured">
    <div class="project-card__topline"><span class="project-card__label">Principal Investigator</span><span class="project-card__status">Active</span></div>
    <h3>Zero-Shot Fingerprinting of Encrypted Websites via Cross-Modal Cognitive Alignment</h3>
    <p>Develop theory and methods for recognizing encrypted websites in zero-shot settings through cross-modal cognitive alignment.</p>
    <div class="project-card__meta"><span>2027.01 - 2029.12</span><span>Shenzhen, China</span></div>
  ...
  <article class="project-card">
    ...
    <p>Contribute to key technologies, system development, and practical applications for a support platform.</p>
    <div class="project-card__meta"><span>Shenzhen, China</span><span>Major national-laboratory project</span></div>
    <p class="project-card__funding">Project funding <span>·</span> CNY 8.77M</p>
  </article>
  <article class="project-card">
    ...
    <p>Investigate offensive and defensive techniques for artificial intelligence systems and their security implications.</p>
    <div class="project-card__meta"><span>Singapore</span><span>National R&amp;D project</span></div>
    <p class="project-card__funding">Project funding <span>·</span> CNY 35.62M</p>
  </article>
  <article class="project-card">
    ...
    <p>Study traffic analysis methods and privacy protections for encrypted communications.</p>
    <div class="project-card__meta"><span>Hong Kong, China</span><span>Research grant</span></div>
    <p class="project-card__funding">Project funding <span>·</span> CNY 350,000</p>
  </article>
</div>
...
<div class="education-list">
  <article class="education-item">
    ...
    <div>
      ...
      <p class="education-detail">GPA 4.06 / 4.3 <span>·</span> Supervisors: Charles Zhang and Tao Wang</p>
    </div>
  </article>
  <article class="education-item">
    ...
    <div>
      ...
      <p class="education-detail">GPA 3.82 / 4.0 <span>·</span> Ranked 1st in a cohort of 64 <span>·</span> Supervisor: Yumu Li</p>
    </div>
  </article>
</div>
...
<div class="skills-grid">
  <div class="skill-group"><span class="skill-label">Research areas</span><div class="skill-pills"><span>Network security</span><span>Encrypted traffic analysis</span><span>Privacy</span><span>AI security</span></div></div>
  ...
  <div class="skill-group"><span class="skill-label">Languages</span><div class="skill-pills"><span>English · IELTS 7.5</span><span>CET-6 · 594</span></div></div>
</div>
